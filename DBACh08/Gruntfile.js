	    ...
	    processhtml: {
	        build: {
	            files: {
	                ...
	                'dist/js/views/stockcartcollectionview.js' : ['src/js/views/stockcartcollectionview.js'], // temp solution
	                'dist/js/views/stockitemcollectionview.js' : ['src/js/views/stockitemcollectionview.js'], // temp solution
	                'dist/js/views/stockitemview.js' : ['src/js/views/stockitemview.js'], // temp solution       
	                ...
	                'dist/js/models/stockitem.js' : ['src/js/models/stockitem.js'], // temp solution
	                ...
	                'dist/js/collections/stockcart.js' : ['src/js/collections/stockcart.js'], // temp solution
